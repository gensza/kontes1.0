        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form action="proses/prosesGantiPassword.php" method="POST">
                  <div class="form-group">
                    <label>Kata Sandi Lama</label>
                    <input class="form-control" name="password" type="password" id="level" required="">
                  </div>
                  <div class="form-group">
                    <label>Kata Sandi Baru</label>
                    <input class="form-control" name="passwordBaru" id="password" type="password" required="">
                  </div>
                  <div class="form-group">
                    <label>Ulang Kata Sandi Baru</label>
                    <input class="form-control" name="passwordBaru2" id="password" type="password" required="">
                  </div>                
                  <div class="form-group">
