	...
	if($sql){
		...
		if($result){
			echo "<script>
				Swal.fire({
				  icon: 'success',
				  title: 'Pesanan $np Berhasil Dibatalkan !'
				})
				</script>";
				echo "<meta http-equiv='refresh' content='3; url=../../../?page=transaksiMasuk'>";
		}else{
			echo "<script>
				alert('Pesanan Anda Tidak Berhasil Dibatalkan !');window.location.href='../../../?page=transaksiMasuk'
				</script>";
		}
	}
} 
